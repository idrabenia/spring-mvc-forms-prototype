...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/ext/bootstrap-2.1.1/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/ext/bootstrap-2.1.1/css/bootstrap-responsive.min.css" type="text/css">
            ...
            <div class="container">
                ...
                <div class="nav-collapse">
                    ...
                    <p class="navbar-text pull-right">
                        <a href="#login"class="btn btn-primary" style="margin-top: 0;">Login</a>
                    </p>
                </div>
            </div>
        </div>
